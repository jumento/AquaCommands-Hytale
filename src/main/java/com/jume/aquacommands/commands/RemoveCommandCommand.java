...
public class RemoveCommandCommand extends AbstractPlayerCommand {
    ...
    public RemoveCommandCommand(AquaCommands mod) {
        super("aquacmdremove", "Remove a custom command", false);
        this.mod = mod;
    ...
    protected void execute(
        ...
        player.getPageManager().openCustomPage(ref, store, new CommandRemovePage(playerRef, mod.getCommandManager()));
    }
}
